  ...
  <div class="h-screen bg-gray-900 flex flex-col overflow-hidden">
    ...
    >
      ...
      <template v-if="selectedPositionGroup">
        ...
        <!-- Chart Tab -->
        <div v-show="tradeDetailTab === 'chart'" class="h-[550px] overflow-y-auto">
          <!-- Intraday Charts -->
          <IntradayChart
        ...
        <!-- Details Tab -->
        <div v-show="tradeDetailTab === 'details'" class="h-[550px] overflow-y-auto">
        ...
        <!-- News Tab -->
        <div v-show="tradeDetailTab === 'news'" class="h-[550px] overflow-y-auto space-y-4">
